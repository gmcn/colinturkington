	...
	<header>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-6">
					<a href="/">
						<img class="branding wow fadeInLeft" width="300px" src="<?php echo get_template_directory_uri(); ?>/images/colinturkington-logo.svg" alt="<?php bloginfo( 'name' ); ?> | <?php echo $description; ?>"  />
					</a>
				</div>
